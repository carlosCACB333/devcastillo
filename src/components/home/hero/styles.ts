  ...
  variants: {
    theme: {
      nextui: {
        ...
        sizeOption: ['group-data-[selected=true]:bg-primary', 'group-data-[selected=true]:text-primary-foreground'],
      ...
      elegant: {
        wrapper: 'rounded-xs',
        contentWrapper: 'ml-3',
        imageWrapper: ['lg:scale-[1.3]', 'before:rounded-xs', 'before:from-[#323232] before:to-[#000000]', 'shadow-xl'],
