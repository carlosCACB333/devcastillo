...
import { Category, Certification, Locale, Project, Stage } from '@/generated/graphql';
import { GRAPH_SDK } from '@/utils/sdk';
import { AiFillSafetyCertificate, AiOutlineFundProjectionScreen } from 'react-icons/ai';
import { BsFillPostcardFill } from 'react-icons/bs';

export default async function Home() {
  const { categories, certifications, certificationsConnection, postsConnection, projectsConnection, projects } =
  ...
  return (
    <div className='container mx-auto max-w-7xl grow px-6'>
      <main>
        ...
        <AboutSection />
        <ExperienceSection />
        <SkillSection categories={categories as Category[]} />
        <ProjectSection projects={projects as Project[]} />
        <CertificateSection certifications={certifications as Certification[]} />
        <ContactSection />
      </main>
      <Footer />
      <ChatBoot />
